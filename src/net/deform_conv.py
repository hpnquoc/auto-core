...
class DCN_layer(nn.Module):
    ...
    def forward(self, input_feat, inter):
        ...
        return deform_conv2d(input=input_feat, offset=offset, weight=self.weight, bias=self.bias, stride=self.stride, padding=self.padding, dilation=self.dilation, mask=mask)