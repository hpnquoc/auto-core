...
if __name__ == '__main__':
    ...
    if opt.mode == 0:
        ...
        opt.batch_size = 5
        ckpt_path = opt.ckpt_path + 'Dinov2/last.pth'
    ...
    # Make network
    net = AirNet(opt, encoder='vitl', features=64, out_channels=[48, 96, 192, 384], use_bn=False, use_clstoken=False).cuda()
    net.eval()
    net.load_state_dict(torch.load(ckpt_path, map_location=torch.device(opt.cuda))['net'])
    net.training = False
